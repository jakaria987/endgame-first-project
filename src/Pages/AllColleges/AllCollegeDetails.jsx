...
const AllCollegeDetails = () => {
  ...
  const {
    ...
    return (
      ...
      <figure>
        <img
        className="w-3/5 h-3/5 mt-10 rounded-3xl"
        src={college_image}
        alt="Shoes"
        />
      </figure>
      <div className="card-body">
        ...
        <div className="grid md:grid-cols-2 gap-20 mx-auto bg-cyan-300 h-60 px-4 py-4 rounded-tr-3xl ">
        ...
        <div className="grid md:grid-cols-2 gap-16 mx-auto bg-cyan-300 px-4 py-4 h-60 rounded-tr-3xl ">
        <div className="text-cyan-700 font-semibold text-lg">
        ...
        <div className="grid md:grid-cols-2 gap-12 mx-auto bg-cyan-300 h-60 px-4 py-4 rounded-tr-3xl">
        <div className="text-cyan-700 font-semibold text-lg">
        ...
        <Link to='/allColleges' className="btn hover:btn-info w-1/6 font-extrabold mx-auto mt-6">Go Back</Link>
      </div>
    </div>
    );
};

export default AllCollegeDetails;